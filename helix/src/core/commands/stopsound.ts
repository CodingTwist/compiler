...
/** `stopsound` */
export class StopsoundNode extends CommandNodeBase {
...
export class StopsoundHandler extends TreeCommandHandler<StopsoundNode> {
  readonly type: StopsoundNode["type"] = "stopsound";
}
