...
export const EFFECT: EntityNbtSchema<EffectFields> = {
  id: field({
    key: "id",
    was: { key: "Id", until: "1.20.2" },
    encode: encodeId,
  }),
  amplifier: field({
    key: "amplifier",
    was: { key: "Amplifier", until: "1.20.2" },
    encode: Byte,
  }),
  duration: field({
    key: "duration",
    was: { key: "Duration", until: "1.20.2" },
  }),
  ambient: field({
    key: "ambient",
    was: { key: "Ambient", until: "1.20.2" },
    encode: asByte,
  }),
  showParticles: field({
    key: "show_particles",
    was: { key: "ShowParticles", until: "1.20.2" },
    encode: asByte,
  }),
  showIcon: field({
    key: "show_icon",
    was: { key: "ShowIcon", until: "1.20.2" },
    encode: asByte,
  }),
