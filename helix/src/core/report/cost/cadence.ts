 ...
 */
export function cadence(dp: Datapack, roots: string[], allows: Map<string, string> | undefined) {
...
export function guardedFns(dp: Datapack, roots: string[], period: Map<string, number>): Set<string> {
