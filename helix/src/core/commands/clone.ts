...
/** `clone` */
export class CloneNode extends CommandNodeBase {
  readonly type = "clone";
}

export class CloneBuilder extends CommandBuilder<CloneNode> {
...
export class CloneHandler extends TreeCommandHandler<CloneNode> {
  readonly type: CloneNode["type"] = "clone";
}
