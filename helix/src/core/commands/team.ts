...
/** `team` */
export class TeamNode extends CommandNodeBase {
  readonly type = "team";
}

export class TeamBuilder extends CommandBuilder<TeamNode> {
...
export class TeamHandler extends TreeCommandHandler<TeamNode> {
  readonly type: TeamNode["type"] = "team";
}
