...
/** `bossbar` */
export class BossbarNode extends CommandNodeBase {
  readonly type = "bossbar";
}

export class BossbarBuilder extends CommandBuilder<BossbarNode> {
...
export class BossbarHandler extends TreeCommandHandler<BossbarNode> {
  readonly type: BossbarNode["type"] = "bossbar";
}
